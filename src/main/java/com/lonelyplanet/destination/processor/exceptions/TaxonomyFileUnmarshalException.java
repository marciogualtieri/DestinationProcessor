...
public class TaxonomyFileUnmarshalException extends Exception {
    private static final long serialVersionUID = 1L;

    public TaxonomyFileUnmarshalException(String fileNameAndPath, Exception exception) {
    ...
    private static String buildMessage(String fileNameAndPath, Exception exception) {
        return String.format(ExceptionMessages.TAXONOMY_FILE_UNMARSHAL_EXCEPTION_MESSAGE_FORMAT,
